...
with c1: st.image("assets/logo.svg")
...
st.info("PDF export is disabled in this Cloud build to avoid install issues. To enable, add `reportlab` to requirements and a `utils/report.py` with PDF logic.")
